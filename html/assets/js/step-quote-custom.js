$(document).ready(function () {
  $("#next-step-2").click(function () {
    ...
    $("#step-quote-forms-tabs #tabs-step-list-header01").removeClass("active").addClass("done");
  ...
  $("#next-step-3").click(function () {
    ...
    $("#step-quote-forms-tabs #tabs-step-list-header01").removeClass("active").addClass("done");
    $("#step-quote-forms-tabs #tabs-step-list-header02").removeClass("active").addClass("done");
  ...
  $("#previous-step-1").click(function () {
    ...
    $("#step-quote-forms-tabs #tabs-step-list-header01").addClass("active").removeClass("done");
  ...
  $("#previous-step-2").click(function () {
    ...
    $("#step-quote-forms-tabs #tabs-step-list-header02").addClass("active").removeClass("done");
